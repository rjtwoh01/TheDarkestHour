...
namespace The_Darkest_Hour
{
    class Battle
    {
        ...
        public void DoBattle2(Player myHero, Mob mob)
        {
            bool battleInProgress = true;
            ...
            do
            {
                ...
                if (answer == "Attack")
                {
                    ...
                    switch (profession)
                    {
                        ...
                        case "Rogue":
                            {
                                attack = rogue.GetAttack(myHero);
                                playerDamage = rogue.CalculateDamage(myHero, attack);
                                if (playerDamage == 0)
                                {
                                    DisplayStats(myHero, mob);
                                }
                        ...
                        case "Hunter":
                            do
                            {
                                attack = ranger.GetAttack(myHero);
                                playerDamage = ranger.CalculateDamage(myHero, attack);
                                if (playerDamage == 0)
                                {
                                    DisplayStats(myHero, mob);
                                }
                        ...
                        case "Warrior":
                            do
                            {
                                attack = warrior.GetAttack(myHero);
                                playerDamage = warrior.CalculateDamage(myHero, attack);
                                if (playerDamage == 0)
                                {
                                    DisplayStats(myHero, mob);
                                }
                        ...
                        case "Guardian":
                            do
                            {
                                attack = guardian.GetAttack(myHero);
                                playerDamage = guardian.CalculateDamage(myHero, attack);
                                if (playerDamage == 0)
                                {
                                    DisplayStats(myHero, mob);
                                }
                        ...
                        case "Mage":
                            do
                            {
                                attack = mage.GetAttack(myHero);
                                playerDamage = mage.CalculateDamage(myHero, attack);
                                if (playerDamage == 0)
                                {
                                    DisplayStats(myHero, mob);
                                }
                        ...
                        case "Cleric":
                            do
                            {
                                attack = cleric.GetAttack(myHero);
                                playerDamage = cleric.CalculateDamage(myHero, attack);
                                if (playerDamage == 0)
                                {
                                    DisplayStats(myHero, mob);
                                }
